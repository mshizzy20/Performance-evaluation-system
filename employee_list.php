<?php
    ...
    else
    {
        ...
        if ($systemAccessValueRow !== 5)
        {
            ...
            // destroy session
            session_destroy();
            header("Location: login.php?loginError=loginError01&link=employeeList");
            exit();
        }
?>
        <!DOCTYPE html>
        <html lang="en">
            <head>
                ...
                <title>epes | Employee List</title>
                            ...
                            ?>
                                        <div class="col-sm-6 col-md-4 col-lg-4 mx-auto">
                                            <div class="alert alert-info text-center" role="alert">
                                                ...
                                                <br><br>
                                                <a class="text-decoration-none btn btn-sm btn-primary btn-block" href="new_employee.php"><i class="fa fa-plus"></i> Add new staff</a>
                                            </div>
                                        </div>
                                    <?php }else{ ?>
                                        <div class="col-lg-12">
                                            <div class="card card-outline card-success">
                                                <div class="card-header">
                                                    <div class="card-tools">
                                                        <a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="new_employee.php"><i class="fa fa-plus"></i> Add new employee</a>
                                                    </div>
                                                </div>
                                                <div class="card-body">
                                                    <!-- <table class="table tabe-hover table-bordered" id="list"> -->
                                                    <table class="table tabe-hover table-bordered" id="employeeList">
                                                        <thead>
                                                            <tr>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                    <tr>
                                                                        ...
                                                                        <td><b><?php echo $selectAllStaffRow['user_Pf_Number'] ?></b></td>
                                                                        ...
                                                                        <td class="text-center">
                                                                            ...
                                                                            <div class="dropdown-menu" style="">
                                                                                <a class="dropdown-item view_employee" href="employee_details.php?staffId=<?php echo $selectAllStaffRow['user_Pf_Number']; ?>">
                                                                                    View
                                                                                </a>
