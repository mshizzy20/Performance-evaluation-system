...
?>
        ...
        <html lang="en">
            <head>
                ...
                <title>epes | Details for <?php echo escapeCharacters($Fetched_first_name); ?></title>
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="content-header">
                            <div class="container-fluid">
                                <div class="row mb-2">
                                    <div class="col-sm-6">
                                        <h1 class="m-0">Details for <?php echo escapeCharacters($Fetched_first_name.' '.$Fetched_middle_name.' '.$Fetched_last_name); ?></h1>
                                    </div>
                                </div>
                            ...
                            <div class="container-fluid">
                                <div class="card card-widget widget-user shadow">
                                    <div class="widget-user-header bg-dark">
                                        <h3 class="widget-user-username"><?php echo escapeCharacters($Fetched_first_name.' '.$Fetched_middle_name.' '.$Fetched_last_name); ?></h3>
                                        <h5 class="widget-user-desc"><?php echo escapeCharacters($Fetched_email); ?></h5>
                                    </div>
                                    <div class="widget-user-image">
                                        <?php
                                            if (empty($Fetched_avatar) == true || $Fetched_avatar == 'notSet' || empty($Fetched_avatar) == false && is_file('userProfilePictures/'.$Fetched_avatar) == false)
                                            {
                                        ?>
                                            <span class="brand-image img-circle elevation-2 d-flex justify-content-center align-items-center bg-primary text-white font-weight-500" style="width:90px;height:90px">
                                                <h4>
                                                    <?php echo escapeCharacters(strtoupper(substr($Fetched_first_name, 0,1).substr($Fetched_last_name, 0,1))); ?>
                                                </h4>
                                            </span>
                                        <?php }else{ ?>
                                            <img class="img-circle elevation-2" src="userProfilePictures/<?php echo escapeCharacters($Fetched_avatar); ?>" alt="User Avatar"  style="width:90px;height:90px;object-fit:cover">
                                        <?php } ?>
                                    </div>
                                        ...
                                        <div class="container-fluid">
                                            ...
                                            ?>
                                                <dl>
                                                    <dt>Department id</dt>
                                                    <dd>
                                                        <?php echo escapeCharacters($selectDepartmentDetailsSTMTRow["department_id"]); ?>
                                                    </dd>
                                                </dl>
                                                <dl>
                                                    <dt>Department name</dt>
                                                    <dd>
                                                        <?php echo escapeCharacters($selectDepartmentDetailsSTMTRow["department_name"]); ?>
                                                    </dd>
                                                </dl>
                                            <?php } ?>
                                            <dl>
                                                ...
                                                <dd>
                                                    <a href="mailto:<?php echo $Fetched_email; ?>">
                                                        <?php echo escapeCharacters($Fetched_email); ?>
                                                    </a>
                                                </dd>
                                            </dl>
                                            <dl>
                                                <dt>Last login</dt>
                                                <dd>
                                                    <?php echo escapeCharacters(date('l, dS \o\f F Y h:i:s A',strtotime($Fetched_last_login))); ?>
                                                </dd>
                                            </dl>
                                            <dl>
                                                <dt>Last seen</dt>
                                                <dd>
                                                    <?php
                                                        if($Fetched_last_seen==="online")
                                                        {
                                                            echo "<span class='text-success'>Online</span>";
                                                        }
                                                        else
                                                        {
                                                            echo escapeCharacters(date('l, dS \o\f F Y h:i:s A',strtotime($Fetched_last_seen)));
                                                        }
                                                    ?>
                                                </dd>
                                            </dl>
