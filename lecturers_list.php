<?php
    ...
    else
    {
        ...
        if ($systemAccessValueRow !== 5)
        {
            ...
            // destroy session
            session_destroy();
            header("Location: login.php?loginError=loginError01&link=lecturers_list");
            exit();
        }
?>
        <!DOCTYPE html>
        <html lang="en">
            <head>
                ...
                <title>epes | Lecturers list</title>
            ...
            <body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                            ...
                            ?>
                                        <div class="col-sm-6 col-md-4 col-lg-4 mx-auto">
                                            <div class="alert alert-info text-center" role="alert">
                                                There is no lecturer currently!
                                                <br><br>
                                                Would you like to add one?
                                                <br><br>
                                                <a class="text-decoration-none btn btn-sm btn-primary btn-block" href="new_employee.php"><i class="fa fa-plus"></i> Add new lecturer</a>
                                            </div>
                                        </div>
                                    <?php }else{ ?>
                                        <div class="col-lg-12">
                                            <div class="card card-outline card-success">
                                                <div class="card-header">
                                                    <div class="card-tools">
                                                        <a class="btn btn-block btn-sm btn-default btn-flat border-primary" href="new_employee.php"><i class="fa fa-plus"></i> Add new lecturer</a>
                                                    </div>
                                                </div>
                                                <div class="card-body">
                                                    <table class="table tabe-hover table-bordered" id="lecturersListDataTables">
                                                        <thead>
                                                            <tr>
                ...
                <script>
                    ...
                    {
                        $('#lecturersListDataTables').DataTable();
                    } );
                </script>
            </body>
        </html>
